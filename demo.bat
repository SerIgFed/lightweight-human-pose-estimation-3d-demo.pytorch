...
: video-3
python demo.py --rotate	--video %BA_DIR%/14.C_20220603-153015--20220603-162015.avi

: video-4
python demo.py --rotate	--video %BA_DIR%/14.C_20220604-073015--20220604-090015.avi
